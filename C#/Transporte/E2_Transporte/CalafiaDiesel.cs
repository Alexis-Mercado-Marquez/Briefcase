...
namespace E2_Transporte
{
    class CalafiaDiesel : Calafias 
    {
        ...
        public CalafiaDiesel(string color, string chofer, float tarifa, float tarifa_est, string placa, int modelo, int capacidad, float velocMax, float capacLitros, int numCilindros, bool bio) : 
