...
namespace E2_Transporte
{
    class CalafiaMixta : Calafias
    {
        ...
        public CalafiaMixta(string color, string chofer, float tarifa, float tarifa_est, string placa, int modelo, int capacidad, float velocMax, float capacLitros, int numCilindros, float cargaMax) : 
