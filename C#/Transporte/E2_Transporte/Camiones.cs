...
{
    public abstract class Camiones
    {
        ...
        public Camiones() { }
        public Camiones(string color, string chofer, float tarifa, float tarifa_est, string pago, string placa, int modelo, int capacidad)
        {
            Color = color;
            Chofer = chofer;
            Tarifa = tarifa;
        ...
        public bool Inserta_Camion(string Motor) 
        {
            bool logro = false;
            try //Por si errores
            {
                ...
                {   //Se insertan los datos del objeto en la BD
                    ...
                    subir.Parameters.AddWithValue("TipoTrans", "Camion");
                    ...
                    subir.Parameters.AddWithValue("Mom_Pago", "Subida");
